...
router.post('/new-client', authMiddleware, retreatMiddleware, (req, res) => {
        ...
        .then(user => {
            ...
            user.save()
                .then(savedUser => {
                    ...
                    return res.json({ client: returnClient });
                })
                .catch(() => {
                    return res.status(500).json({ msg: "Internal server error" });
                })
...
router.post('/remove-client', authMiddleware, retreatMiddleware, (req, res) => {
...
router.get('/send-email', authMiddleware, retreatMiddleware, (req, res) => {
...
router.post('/update-client-profile', authMiddleware, retreatMiddleware, (req, res) => {
    const { 
