...
class GroupListItem extends Component {
    ...
    getTable = () => {
        ...
        if(group_members.length === 0) return (<p>{'Start by adding some group members :)'}</p>)

        return (
            <div className='tableFixHead'>
                <Table className='mt-3 p-3'>
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Sleep</th>
    ...
    render() {
        return (
            <ListGroupItem key={this.props.group.id} className="justify-content-between py-0">
